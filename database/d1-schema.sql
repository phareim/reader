...
CREATE TABLE IF NOT EXISTS "Feed" (
  ...
  -- Deck half-life in hours (migration 019). NULL = default pace (720h/30d),
  -- -1 = the ∞ pace (never fades). Unread articles older than 3 half-lives
  -- fade from decay-scoped queries.
