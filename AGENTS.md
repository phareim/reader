...
|---|---|
| API routes, auth, D1/R2, feed sync, full-text, rigs, Discover crawl | [`server/AGENTS.md`](server/AGENTS.md) |
| Tufte primitives, card deck, grid, styling, design system | [`components/AGENTS.md`](components/AGENTS.md) |
| The four rooms, the reader, keyboard shortcuts | [`pages/AGENTS.md`](pages/AGENTS.md) |
| Pure logic: gestures, pagination, sanitization, chunking | [`utils/AGENTS.md`](utils/AGENTS.md) |
| Sleeper-side collectors, systemd timers, candidate miners | [`scripts/AGENTS.md`](scripts/AGENTS.md) |
| Writing or fixing a test | [`__tests__/AGENTS.md`](__tests__/AGENTS.md) |
| Composables (global state vs per-instance surfaces) | [`composables/AGENTS.md`](composables/AGENTS.md) |
...
- **Styling**: Tailwind CSS themed by the **Tufte Viz design system** (see [`components/AGENTS.md`](components/AGENTS.md)), `@tailwindcss/typography` for reader prose
...
**Adding a new composable**: Create in `composables/` directory. Will be auto-imported. Use `useState` for global reactive state; use plain refs for a per-instance surface owned by one mounted component. See [`composables/AGENTS.md`](composables/AGENTS.md) for the distinction.
