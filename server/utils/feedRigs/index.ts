...
import { anthropicRig } from './anthropic'
import { kode24Rig } from './kode24'
 ...
 */
const RIGS: FeedRig[] = [smbcRig, oglafRig, daringFireballRig, xkcdRig, oatmealRig, pluralisticRig, anthropicRig, kode24Rig]
